...
const Layout = ({ children, title, content }) => {
    ...
    const playMusic = () => {
        ...
        music ? audioTag.pause() : audioTag.play() 
    }
    ...
    return (
        <div>
            ...
            <div className={layout.background}>
                <video muted autoPlay="true" loop="true" id={layout.bgVideo}>
                    <source src="/assets/hero_portfolio.mp4" type="video/mp4" />
                </video>
                <audio loop id='song'>
                    <source src='/assets/lofi-hip-hop.mp3' type="audio/mpeg"/>
                </audio>
                {children}

                <button onClick={playMusic} className={layout.music_btn}>
